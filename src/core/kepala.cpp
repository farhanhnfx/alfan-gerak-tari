...
void Kepala::setPosition(int gp_kepala41, int gp_kepala42, int gp_kepala43, int speed) {
    // Set posisi servo kepala
    ServoManager::goal_positions[41] = alfan::ConvertUtils::degreeToValueXL320(gp_kepala41);
    ServoManager::goal_positions[42] = alfan::ConvertUtils::degreeToValueXL320(gp_kepala42);
    ServoManager::goal_positions[43] = alfan::ConvertUtils::degreeToValueXL320(gp_kepala43);
